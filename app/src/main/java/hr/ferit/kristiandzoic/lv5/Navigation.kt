...
import hr.ferit.kristiandzoic.lv5.ui.RecipeDetailsScreen
import hr.ferit.kristiandzoic.lv5.ui.RecipesScreen
...
fun NavigationController() {
    ...
    Routes.SCREEN_ALL_RECIPES) {
        composable(Routes.SCREEN_ALL_RECIPES) {
            RecipesScreen(recipes = recipes, navigation = navController)
        }
        composable(
